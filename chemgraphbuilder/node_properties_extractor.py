"""
This module defines the `NodePropertiesExtractor` class, which is responsible for 
extracting data from the PubChem database to build knowledge graphs in Neo4j. 
The class focuses on nodes representing chemical entities and their
relationships, allowing users to query chemical data and construct a graph-based 
...
class NodePropertiesExtractor:
    ...
    def _make_request(self, url):
        ...
        of attempts with exponential backoff to handle potential
    ...
    def run(self):
        ...
        if removed_enzymes:
            print("These enzymes were removed because their names aren't correct:",
